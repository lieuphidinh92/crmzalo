<template>
  ...
  >
    ...
    <div class="pa-3">
      ...
      <v-btn color="primary" block :loading="saving" @click="saveContact">
        Lưu thông tin
      </v-btn>
      ...
      <ChatAiInsights :results="aiResults" />
...
import ChatAiInsights from './ChatAiInsights.vue';
