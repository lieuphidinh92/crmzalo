...
- **Chính sách công nợ không tham gia luồng lên đơn.** Không cảnh báo và không chặn
  theo hạn mức/số ngày; chỉ thiếu hàng hoặc thiếu thông tin vận hành mới chặn sale.
